...
- Usually would do these before posterior predictive checks, but easier to explain once you onderstand what posterior predictive checks are 
...
1. Calculate the probability that $\beta_{1}$ is < 0.51

2. Calculate the posterior predictive distribution one might expect for y if they went out and collected data at x1 = 1.23

3. Plot the median fit +/- 95% credible intervals from the posterior predictive distribution of y vs. x. 

4. Repeat the exercises in this presentation by first simulating your own linear regression dataset to prove to yourself that your code is returning reasonable answers.

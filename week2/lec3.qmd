...
# compare original data against 35 simulated datasets:
p <- ppc_hist(y = data$y, yrep = as.matrix(y_rep[1:35, ]))
...
Vehtari et al. 2019. [Rank-normalization, folding, and localization:
An improved Rb for assessing convergence of MCMC*](https://arxiv.org/pdf/1903.08008.pdf)

Gabry et al. 2019. [Visualization in Bayesian workflow](https://academic.oup.com/jrsssa/article/182/2/389/7070184)

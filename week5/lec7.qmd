...
A biologist wants to know whether scorpionsin populations 2 and 3 are "different".  Kick out the difference between $\alpha_{pop_{2}}$ and $\alpha_{pop_{3}}$ as a derived variable.  Calculate the $\text {Pr} (\alpha_{pop_{2}} > \alpha_{pop_{3}})$ and report this information back to your biologist friend.

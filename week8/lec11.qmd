...
subtitle: FW 891 <br> [Click here to view presentation online](https://qfcatmsu.github.io/FW-Bayes/week8/lec11.html){style="position:absolute;top:40%;left:35%;font-size:20px;"}
...
[Paraphrased from Fisher 1935 and Tobler 1970]{.footerRight}

[Photo credit: accuweather.com]{.footerLeft}
...
"*Before starting the analysis carefully consider which observations for your response variable can be dependent. If dependency is present, apply a statistical technique that is able to cope with it*"
...
-   Zuur and Ieno 2016. A protocol for conducting and presenting results of regression-type analyses. Methods in Ecology and Evolution. 7: 636--664.

-   Zuur, A.F., Ieno, E.N., and Saveliev, A.A. 2017. Spatial, temporal and spatial--temporal ecological data analysis with R-INLA. Highland Statistics Ltd.

...
-   Idea: define a test statistic and compare that statistic calculated for the original data to the posterior distribution of that test statistic for "replicate" datasets

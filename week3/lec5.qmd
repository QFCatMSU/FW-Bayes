...
-   Several ways to do this, but here we'll do a demo of `browser()` and traceback
...
-   Abstract and not well implemented (C.Belinsky, pers.comm. 2023)
-   This is what I mainly use to debug R code
...
-   Next few weeks, move into nonlinear and mixed effects modeling (where we will likely experience some of these warnings/issues)
...
Stan documentation. 2023. [https://mc-stan.org/docs/reference-manual/index.html](https://mc-stan.org/docs/reference-manual/index.html)

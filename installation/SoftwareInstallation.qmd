...
[R for Mac](https://cran.r-project.org/bin/macosx/): There are two download options (M1/M2 and Intel) -- your Mac will tell you if you try to install the wrong version
...
A pop-up will appear (sometimes in the background) asking you:\
...
<a href="https://cdn.jsdelivr.net/gh/QFCatMSU/FW-Bayes/installation/Installation_Test.R">Download this script (Installation_Test.R)</a> to test the installation. Open the script in RStudio, and click Source. The results should look like this:
